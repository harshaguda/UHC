...
class Humanoid:
    def __init__(self, model_file):
        print(model_file)
        self.model = mujoco.MjModel.from_xml_file(model_file)  # load mujoco model
...
if __name__ == "__main__":
    ...
    smpl_model = mujoco.MjModel.from_xml_file(smpl_model_file)
    sim_model = mujoco.MjModel.from_xml_file(master_foot_model_file)
